        <nav class="bg-gray-800" x-data="{ isOpen: false }">
                                    ...
                                    @if (Auth::check())
                                        <button type="button" @click = "isOpen =  !isOpen"
                                            ...
                                            <img class="size-8 rounded-full"
                                                src="{{ Auth::user()->avatar ? asset('storage/' . Auth::user()->avatar) : asset('img/1000_F_589932782_vQAEAZhHnq1QCGu5ikwrYaQD0Mmurm0N.jpg') }}"
                                                alt="{{ Auth::user()->name }}" />
                                            <div class="text-gray-300 ml-3 text-sm font-medium">{{ Auth::user()->name }}
                                            </div>
            ...
            <div x-show="isOpen" class="md:hidden" id="mobile-menu">
                <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                    ...
                    <x-my-nav-link class="block" href="/contak" :current="request()->is('contak')">Contak</x-my-nav-link>
                </div>
                    ...
                    @if (Auth::check())
                        ...
                        <div class="mt-3 space-y-1 px-2">
                            ...
                            <form method="POST" action="/logout">
                                @csrf
                                <button type="submit"
                                    class="text-start w-full block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white"
                                    role="menuitem" tabindex="-1" id="user-menu-item-2">Log out</button>
                            </form>
                        </div>
                    @else
